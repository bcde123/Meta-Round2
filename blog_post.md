...
reward signal trains the model via GRPO — with every refactoring decision 
feeding into a live CO₂ savings dashboard.

---

## The Architecture at a Glance

![System Architecture Diagram](architecture_pipeline.png)
...
- **GitHub Repository**: [bcde123/Meta-Round2 (april-25-snapshot)](https://github.com/bcde123/Meta-Round2/tree/april-25-snapshot)
- **HuggingFace Space**: [shreeyanshi03/Meta-Round2](https://huggingface.co/spaces/shreeyanshi03/Meta-Round2)
